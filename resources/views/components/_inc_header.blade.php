                ...
                <li class="menu-item-has-children">
                    ...
                    <ul>
                        ...
                        <li class="menu-item-has-children">
                            ...
                            <ul>
                                <li><a href="https://grandetest.com/theme/jobhunt-html/employer_manage_jobs.html" title="">Employer Job Manager</a></li>
        ...
        <div class="container">
            ...
            <nav>
                <ul>
                    ...
                    <li class="menu-item-has-children">
                        <a href="index.html#" title="">Tư vấn</a>
                        <ul>
                    ...
                    @if(get_data_user('users'))
                        <li class="menu-item-has-children">
                            <a href="#" title="">{{ get_data_user('users','name') }}</a>
                            <ul>
